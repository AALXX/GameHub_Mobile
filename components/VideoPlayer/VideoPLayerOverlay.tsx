...
import { playOrPauseVideo } from './UtilFunc'
...
const VideoPLayerOverlay = (props: IOverlayProps) => {
    return (
        <View className="flex flex-col w-full absolute h-[26vh] z-10 bg-[#00000065] ">
            <View>
                {props.playbackInstanceInfo.state === 'Playing' ? (
                    ...
                    >
                        <Image source={require('../../assets/PlayerIcons/Puase_icon.svg')} className="w-12 h-12" />
                    </TouchableOpacity>
                ) : (
                    <TouchableOpacity
                        className="self-center w-[13vw] h-[6vh] mt-20"
                    ...
                    >
                        <Image source={require('../../assets/PlayerIcons/Play_icon.svg')} className="w-12 h-12" />
                    </TouchableOpacity>
                )}
            </View>
            <View className="flex flex-row w-full h-[20%] bg-[#00000065] z-10 self-end mt-[5vh]">
